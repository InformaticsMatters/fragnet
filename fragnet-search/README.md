...
[org.squonk.fragnet.search.model.FragmentGraph](src/main/java/org/squonk/fragnet/search/model/FragmentGraph.java)
Java class.
...
This is a JSON serialised form of the 
[org.squonk.fragnet.search.model.NeighbourhoodGraph](src/main/java/org/squonk/fragnet/search/model/NeighbourhoodGraph.java)
Java class which extends from the `org.squonk.fragnet.search.model.FragmentGraph` class described above.
